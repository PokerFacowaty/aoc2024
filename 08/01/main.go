...
func findAntinodes(ant1 Antenna, ant2 Antenna, maxX int, maxY int) []Antinode {
	...
	*/
	...
	possibleAntinode1 := Antinode{x: ant1.x + antennasOffset1.x*2,
		y: ant1.y + antennasOffset1.y*2}
	possibleAntinode2 := Antinode{x: ant2.x + antennasOffset2.x*2,
		y: ant2.y + antennasOffset2.y*2}

	if possibleAntinode1.x >= 0 && possibleAntinode1.x <= maxX &&
		possibleAntinode1.y >= 0 && possibleAntinode1.y <= maxY {
		result = append(result, possibleAntinode1)
	}
	if possibleAntinode2.x >= 0 && possibleAntinode2.x <= maxX &&
		possibleAntinode2.y >= 0 && possibleAntinode2.y <= maxY {
		result = append(result, possibleAntinode2)
	}
